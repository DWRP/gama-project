...
var OrderController = /** @class */ (function () {
    ...
    OrderController.prototype.show = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, shop, id, data, worspace, result, jsonResult, orderId, statusDescription, value, erro;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        data = {};
                        worspace = shop ? shop + "--" : "";
                        return [4 /*yield*/, api_1.default.get("https://" + worspace + process.env.API_URL + "/oms/pvt/orders/" + id).then(function (item) { return __assign(__assign({}, item.data), { erro: "" }); }).catch(function () {
                                return {
                                    orderId: "",
                                    statusDescription: "",
                                    value: "",
                    ...
                    case 1:
                        ...
                        orderId = jsonResult.orderId, statusDescription = jsonResult.statusDescription, value = jsonResult.value, erro = jsonResult.erro;
                        data = {
                            orderId: orderId,
