        ...
        return `
            <div class="card">
                ...
                <div class="card_info">
                    ...
                    <p><span>Linkedin:</span> <a href="${item.linkedin.contains('https')?item.linkedin:'https://'+item.linkedin}">${item.linkedin.contains('https')?item.linkedin:'https://'+item.linkedin}</a></p><br />
                </div>
            </div>
        `
    })
