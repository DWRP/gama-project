...
de comunicação baseado em um chatbot, que
...
### Versão 2
<h1 align="center">
    <img alt="Example" title="Example" src="frontend/assets/chatbot-v2-1.png" width="90%" />
</h1>
<h1 align="center">
...
Linguagens utilizadas na versão 1.0
...
Linguagens utilizadas na versão 2.0
...
Toda a restruturação do codigo foi realizada, o projeto foi refeito quase que do zero, sendo assim integrado funcionalidades da AWS deixando muito mais rapido, seguro, e inteligente

**frontend:**

    Contém todo conteúdo de estilos e temas da loja da VTEX

**xcbot-app:**

    Contém todo o codigo do chatbot, configurado e com seus respectivos componentes
